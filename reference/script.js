...
const translations = {
  pt: {
    ...
    "hero.lede": "Construo interfaces e sistemas que continuam de pé bem depois do deploy. 10+ anos entre front-end, arquitetura e integrações que precisam funcionar de verdade.",
    ...
    "about.p2": "Gosto de pegar código legado e transformar em algo sustentável, e de construir do zero quando é isso que o projeto pede. Uso IA (Claude, Cursor) como parte do meu fluxo de trabalho todos os dias, sempre revisando e validando o que é gerado, porque quem assina o código sou eu.",

    "exp.eyebrow": "// experiência",
    "exp.title": "Trajetória",
    "exp.present": "atual",
    "exp.gelic.role": "Desenvolvedor Front-End Sênior",
    "exp.gelic.b1": "Arquitetura e desenvolvimento do front-end de um sistema de cotações para o setor automotivo, construído do zero com React, Vite e TypeScript",
    "exp.gelic.b2": "Design System criado do zero: componentes, padrões e documentação em Storybook",
    "exp.gelic.b3": "React Query para data fetching com cache por entidade; formulários complexos com React Hook Form + Zod/Yup",
    "exp.gelic.b4": "Migração de autenticação para cookies HttpOnly com camada BFF própria, reduzindo exposição a XSS/CSRF",
    ...
    "exp.hap.b1": "Único desenvolvedor nos primeiros meses do projeto, responsável por arquitetura, front-end e decisões de produto",
    "exp.hap.b2": "Sistema PWA integrado ao ERP com comunicação em tempo real via WebSockets entre garçom e cozinha",
    ...
    "exp.jd3.b2": "Modernização de ERP legado (Delphi/SQL Server) migrando módulos para Java 17 + Spring Boot e .NET/C#",
    ...
    "proj.furafila.desc": "Do escaneamento do QR code ao ticket final. Backend em .NET 9, monólito modular com EF Core, FluentValidation e Serilog, e PWA em React 19. Integração completa com a Orders API do Mercado Pago (Pix, cartão e balcão), cada fluxo com sua própria validação de webhook via HMAC. Notificações em tempo real com SignalR e Web Push, testes de integração com Testcontainers.",
    "proj.obralog.sub": "App de medições e diário de obra, offline-first",
    "proj.obralog.desc": "React Native com Expo e SQLite local: toda escrita é salva primeiro no dispositivo, sem esperar rede. Sincronização bidirecional com o backend, incluindo resolução de conflitos e upload de fotos. Backend em .NET 9 Minimal APIs + EF Core, atuando como intermediário para um sistema de terceiro.",
    "proj.note": "Mais projetos pessoais a caminho, um por stack diferente. Os repositórios acima são privados, mas posso mostrar o código em uma conversa.",

    "contact.eyebrow": "// contato",
    "contact.title": "Vamos conversar",
    "contact.sub": "Aberto a oportunidades remotas, PJ ou CLT, em times que valorizam arquitetura bem pensada e código que dura.",
  ...
  en: {
    ...
    "hero.lede": "I build interfaces and systems that keep running well after launch day. 10+ years across front-end, architecture and integrations that need to actually work.",
    ...
    "about.p1": "I've been a full stack developer for over 10 years, with a strong root in front-end (React, TypeScript, Next.js) and real hands-on back-end work (.NET, Node.js, Java/Spring Boot). Most of my career was spent on small, lean teams, which meant learning a bit of everything: architecture, technical decisions, deployment, and sitting with end users to see if the system actually solves their problem.",
    "about.p2": "I like turning legacy code into something sustainable, and building from scratch when that's what the project needs. I use AI (Claude, Cursor) as part of my daily workflow, always reviewing and validating what gets generated, because I'm the one who signs off on the code.",

    "exp.eyebrow": "// experience",
    "exp.title": "Career path",
    "exp.present": "present",
    "exp.gelic.role": "Senior Front-End Developer",
    "exp.gelic.b1": "Architecture and front-end development of a quoting system for the automotive sector, built from scratch with React, Vite and TypeScript",
    ...
    "exp.hap.b1": "Sole developer in the project's early months, owning architecture, front-end and product decisions",
    "exp.hap.b2": "PWA system integrated with an ERP, with real-time communication via WebSockets between waitstaff and kitchen",
    ...
    "exp.jd3.b3": "On-site usability validation with end users of ERP, production planning and warehouse management systems",
    ...
    "proj.furafila.desc": "From QR code scan to final ticket. Backend in .NET 9, modular monolith with EF Core, FluentValidation and Serilog, and a React 19 PWA. Full integration with Mercado Pago's Orders API (Pix, card and counter), each flow with its own HMAC-validated webhook. Real-time notifications via SignalR and Web Push, integration tests with Testcontainers.",
    "proj.obralog.sub": "Offline-first construction site logging app",
    "proj.obralog.desc": "React Native with Expo and local SQLite: every write is saved on-device first, without waiting on the network. Bidirectional sync with the backend, including conflict resolution and photo upload. Backend in .NET 9 Minimal APIs + EF Core, acting as a bridge to a third-party system.",
    "proj.note": "More personal projects on the way, one per stack. The repos above are private, but I'm happy to walk through the code in a conversation.",

    "contact.eyebrow": "// contact",
    "contact.title": "Let's talk",
    "contact.sub": "Open to remote opportunities, contract or full-time, on teams that value thoughtful architecture and code that lasts.",
